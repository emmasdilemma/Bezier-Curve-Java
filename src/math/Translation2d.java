...
public class Translation2d implements Interpolable<Translation2d> {
	...
	/**
	 * Get the angle from offset to this math.Translation2d. This is done by making
	...
	/**
	 *
	 * @return Returns a math.Translation2d that when translated with this
	 *         math.Translation2d becomes 0, 0. Essentially the negative x and y of
	 *         this math.Translation2d.
	 */
	 ...
	 *
	 * @param rotationMat
	 *            math.Rotation matrix to multiply point with
	 * @return
	 * 		Rotated point
	 */
	 ...
	 *
	 * @param delta
	 *            math.Translation2d to change this point by
	 * @return
	 * 		Translated point
	 */
