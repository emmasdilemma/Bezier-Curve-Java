...
public class Rotation implements Interpolable<Rotation> {
	...
	/**
	 * Gets a math.Rotation from a specified degree
	 *
	 * @param angle
	 *            Angle to turn into a rotation matrix
	 * @return
	 * 		math.Rotation from specified angle in argument
	 */
	...
	/**
	 * Gets a math.Rotation matrix from a specified radian
	 *
	 * @param radians
	 *            Radian to turn into a rotation matrix
	 * @return
	 * 		math.Rotation from specified radian in argument
	 */
	 ...
	 *
	 * @return
	 * 		The cosine of this math.Rotation
	 */
	public double cos() {
		return cos;
	}
	 ...
	 *
	 * @return
	 * 		The math.Rotation that when rotated with this math.Rotation moves the cos to 1 and the sin to 0
	 */
	 ...
	 *
	 * @return
	 * 		The math.Rotation that is flipped about the x and y axis
	 */
	 ...
	 *
	 * @param rotationMat
	 *            Multiply this math.Rotation by this specified math.Rotation
	 * @return
	 * 		The multiplied math.Rotation
	 */
